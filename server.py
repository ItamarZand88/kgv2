...
@mcp.tool()
async def create_repo_with_knowledge_graph(repo_path: str, repo_id: str = "") -> dict:
...
@mcp.tool()
async def get_entity_code(repo_id: str, uuids: List[str]) -> dict:
...
@mcp.tool()
async def find_probable_entities(repo_id: str, probable_names: List[str]) -> dict:
...
@mcp.tool()
async def get_repo_entities(repo_id: str) -> dict:
...
@mcp.tool()
async def calc_repo_stats(repo_id: str) -> dict:
...
@mcp.tool()
async def measure_complexity(repo_id: str) -> dict:
...
@mcp.tool()
async def find_hotspots(repo_id: str) -> dict:
...
@mcp.tool()
async def map_dependencies(repo_id: str) -> dict:
...
@mcp.tool()
async def detect_languages(repo_id: str) -> dict:
...
@mcp.tool()
async def evaluate_quality(repo_id: str) -> dict:
...
@mcp.tool()
async def get_repo_audit(repo_id: str) -> dict:
